...
from bot.utils import check, send_message, start_after_comment_text, start_text, gpt_text
from bot.keyboards import generate_menu_keyboard, generate_gpt_keyboard


async def comment_finish(call: types.CallbackQuery, bot: Bot, state: FSMContext) -> None:
